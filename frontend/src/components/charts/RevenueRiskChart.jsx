...
function buildChartData(summary) {
  return [
    { name: "0-3 días", value: Number(summary.bucket0to3 || 0) },
    { name: "4-7 días", value: Number(summary.bucket4to7 || 0) },
    { name: "8-15 días", value: Number(summary.bucket8to15 || 0) },
    { name: "Más de 15 días", value: Number(summary.bucketOver15 || 0) },
  ].filter((item) => item.value > 0);
}

export default function RevenueRiskChart({ summary }) {
